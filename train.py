...
train_loader = KittiDataset('/home/zzg/Datasets/kitti/train2.txt')
...
for iter_num in range(5000):
    ...
    for bnum in range(batch_size):
        image_patchs_l, patch_cods_l, image_patchs_r, patch_cods_r, image_patchs_u, patch_cods_u, image_patchs_d, patch_cods_d, origin_patch, origin_cod ,disp_val, d_cost_l , d_cost_r, d_cost_u, d_cost_d, d_cost_x0 ,x,y= train_loader.getitem(1)
...
#    print(grad_all.size())
    ...
    print(p1p2_x0s)
    print('Iter_num: {}\t Loss: {}\t Grad: {}'.format(iter_num,loss_sum,grad_all))
    writer.add_scalar('loss',loss_sum,iter_num)
    if iter_num%10 == 0:
